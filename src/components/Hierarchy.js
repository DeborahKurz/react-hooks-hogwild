...
|-Nav
|-Display 
    |-FILTER (filters which hogs are greased, & allows the user to sort the    hogs based on name or weight)
    |-TILE (When the user clicks on the hog tile, display the other details)
